...
import { createAPIUser } from "./graphql/mutations";
const client = generateClient();
export default function APIUserCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCredit_card_last4(initialValues.credit_card_last4);
    setPayment_method_id(initialValues.payment_method_id);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createAPIUser.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "APIUserCreateForm")}
      {...rest}
    >
      <TextField
        label="Email"
